        ...
        <div class="container mt-2 mt-md-5 mb-3">
            <form class="bg-white p-2 p-md-5 w mx-auto rounded shadow" action="" method="post" name="contactForm" onsubmit="validate(event)">
                ...
                <?php if(isset($_SESSION['accesslevel'])) { ?>
                    <button type="submit" class="btn btn-warning bg-warning text-white shadow" name="sub">SEND MESSAGE</button>
                <?php } else { ?>
                    <button type="submit" class="btn btn-warning bg-warning text-white shadow" name="submit">SEND MESSAGE</button>
                        <p class="text-center text-dark mt-4">Please <a href="signup.php">sign up</a> or <a href="login.php">log in</a> to send a message.</p>
                <?php } ?>
            </form>
        </div>
