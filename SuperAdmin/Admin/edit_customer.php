                ...
                <div class="p-md-5">
                    <form class="container-fluid" action="" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" name="name" aria-describedby="emailHelp" value="<?php echo $row['user_name']; ?>">
                        </div>
                        <div class="form-group mb-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="password" class="form-control" id="exampleInputEmail1" name="pass" aria-describedby="emailHelp" value="<?php echo 'password'; ?>">
                        </div>
