    ...
    <div class="row mt-5">
        ...
        if($access_level) {
            ...
            if ($ress->num_rows > 0) {
                ...
                $qry = "SELECT * FROM services INNER JOIN category ON services.cat_id = category.cat_id INNER JOIN service_service_provider ON services.service_id = service_service_provider.service_id WHERE service_service_provider.sp_id = $service_provider_id AND services.s_status = 'YES' ";
